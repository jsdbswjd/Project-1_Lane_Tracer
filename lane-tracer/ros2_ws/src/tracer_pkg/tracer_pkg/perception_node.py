...
class PerceptionNode(Node):
    def __init__(self):
        ...
        self.skeleton_debug_publisher = self.create_publisher(
            Image,
            '/real/perception/roi_binary_image',
            10
        )
        ...
        # =====================
        self.front_mask_length_px = 38
        self.front_mask_width_px = 102
        self.front_mask_center_offset_px = 0.0

        self.body_mask_length_px = 48
        self.body_mask_width_px = 70
        self.body_mask_center_offset_px = -44

        # =====================
        # Waypoint traversal params
        # seed -> P1 -> P2 -> P3
        # =====================
        self.seed_waypoint_dist_px = 60
        self.seed_band_width_px = 30.0
        self.max_lateral_px = 70.0

        self.waypoint_step_px = 40.0
        ...
        # ESP32는 /real/path/* split error만 사용한다.
        self.lookahead_distance_px = 50.0
        self.lookahead_min_px = 30.0
        self.lookahead_max_px = 70.0
        ...
        self.seed_max_dist_from_robot_px = 110.0
        self.seed_max_lateral_px = 80.0
        self.seed_max_jump_px = 35.0
        ...
        self.seed_img_max_jump_px = 70.0
        ...
        # =====================
        self.max_chain_jump_px = 22.0
        self.max_path_heading_jump_deg = 32.0

        self.path_hold_max_frames = 7
        ...
        self.get_logger().info(
            f'perception_node pure-pursuit + lateral-error version started. OpenCV={cv2.__version__}'
        )
    ...
    def calculate_error_from_chain_img(self, chain_img, robot_center, robot_heading_deg):
        ...
        실제 ESP32 제어는 /real/path/lateral_error, /real/path/heading_error,
        /real/path/lookahead_error 3개 split topic만 사용한다.
        """
        if chain_img is None or len(chain_img) < 3:
            return None
